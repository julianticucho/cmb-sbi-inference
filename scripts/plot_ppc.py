...
if __name__ == "__main__":
    ...
    # samples_0 = sample_model(
    #     model_filename="tsnpe_maf_mlp_2448_default_standard_unbinned_planck_processing_10000_round_5.pth",
    #     x_obs=x_obs,
    #     num_samples=25000,
    #     round_index=5,
    # )
    ...
    # samples_2 = sample_model(
    #     model_filename="tsnpe_maf_mlp_2448_default_standard_unbinned_planck_processing_18000_round_5.pth",
    #     x_obs=x_obs,
    #     num_samples=25000,
    #     round_index=5,
    # )
    ...
    #     #     [0.9626-0.0057*5, 0.9626+0.0057*5]
    #     # ],
    #     output_name="tsnpe_maf_mlp_2448_default_standard_unbinned_planck_processing_(10000,14000,18000)_round_5.pdf"
    # ) 
    ...
    samples_0 = sample_model(
        model_filename="tsnpe_maf_cnn_skymap_pol_d1s1_skymap_identity_1000_round_1.pth",
        x_obs=x_obs,
        num_samples=25000,
        round_index=1,
    )
    ...
    plot_and_save_ppc(
        samples=[samples_0], 
        true_parameter=theta_true.tolist(),
        param_names=['r', 'A_d', 'beta_d', 'A_s', 'beta_s'],
        param_labels=[r'$r$', r'$A_d$', r'$\beta_d$', r'$A_s$', r'$\beta_s$'],
        sample_labels=['1k sims round 1'],
        sample_colors=['#cccccc'],
        filled=[True],
        limits=[
            [0.025-0.025, 0.025+0.025],
            [5.045-1.585, 5.045+1.585],
            [1.59-0.2, 1.59+0.2],
            [1.935-1.935, 1.935+1.935],
            [-3.0-0.4, -3.0+0.4]
        ],
        output_name="tsnpe_maf_cnn_skymap_pol_d1s1_skymap_identity_1000_round_1.pdf"
    ) 
