...
CONFIG = {
    ...
    # ],
    "limits": [
        [0.022068-0.00022*(1), 0.022068+0.00022*(1)],    
        [0.12029-0.0021*(1), 0.12029+0.0021*(1)],  
        [1.04122-0.00047*(1), 1.04122+0.00047*(1)],      
        [3.098-0.016*(1), 3.098+0.016*(1)],    
        [0.9624-0.0057*(1), 0.9624+0.0057*(1)]
    ],
