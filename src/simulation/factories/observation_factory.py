...
class ObservationFactory:
    ...
    def get_available_configurations():
        return {
            "camb_tt": ObservationFactory.create_camb_tt_observation,
    ...
    @staticmethod
    def create_camb_tt_observation():
        def observation(theta_true: torch.Tensor, seed: Optional[int] = None) -> torch.Tensor:
            available_simulators = SimulatorFactory.get_available_configurations()
            available_pipelines = PipelineFactory.get_available_pipelines()
    ...
    @staticmethod
    def create_binned_planck_tt_observation():
        def observation(theta_true: torch.Tensor, seed: Optional[int] = None) -> torch.Tensor:
            available_simulators = SimulatorFactory.get_available_configurations()
            available_pipelines = PipelineFactory.get_available_pipelines()
            
            simulator = available_simulators["tt"]()
            pipeline = available_pipelines["planck_binning"]()
    ...
    @staticmethod
    def create_planck_tt_200_observation():
        def observation(theta_true: torch.Tensor, seed: Optional[int] = None) -> torch.Tensor:
            available_simulators = SimulatorFactory.get_available_configurations()
            available_pipelines = PipelineFactory.get_available_pipelines()
            
            simulator = available_simulators["tt"]()
            pipeline = available_pipelines["planck_binning_200"]()
