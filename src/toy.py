...
def train_SNPE_C(simulator, prior, num_sims):
...
if __name__ == "__main__":
    ...
    prior = get_prior()
    density_estimator, inference = train_SNPE_C(simulator, prior, num_sims=10000)
    
    from src.inference.utils import save_model
    save_model(density_estimator, os.path.join("results", "synthetic", "model_10000.pkl"))
    ...
    plt.savefig(os.path.join("results", "synthetic", "correlation_10000.png"), dpi=300, bbox_inches='tight')
    ...
    plt.tight_layout()
    plt.savefig(os.path.join("results", "synthetic", "posterior_10000.png"), dpi=300, bbox_inches='tight')
    ...
    plot_tarp(ecp, alpha)
    plt.savefig(os.path.join("results", "synthetic", "tarp_10000.png"), dpi=300, bbox_inches='tight')